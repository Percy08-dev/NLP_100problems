...
# verb_extractorからの変更点 -> 37行目のkeyをsurfaceからbaseに変更. 
def verb_base_extractor(data:List[List[dict]]) -> list:
    # 動詞の基本型(原型)のリストを求める. 
...
def main():
    ...
    verbs = verb_base_extractor(data)    # 32の処理
